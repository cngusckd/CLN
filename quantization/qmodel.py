...
from lbtorch.convrelu import ConvRelu, LBConv
from lbtorch.qfakestub import QFakeStub
from lbtorch.lblinear import LBLinear
...
def qresnet18(n_bits):
    return ResNet(QBasicBlock, [2, 2, 2, 2], n_bits=n_bits)