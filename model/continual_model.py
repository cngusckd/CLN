...
class CL_MODEL(nn.Module):
    ...
    def __init__(self,
        ...
        self.buffer = BUFFER(buffer_memory_size = buffer_memory_size, image_shape = input_size)
        
        
        self.backbone = resnet18(nclasses = nclasses, nf = input_size[0]).to(self._DEVICE)
