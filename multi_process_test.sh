...
run_combination() {
  combo=$1  # Assign the first argument to the combo variable
...
# The -n 1 option specifies that xargs should use one argument per command line
# The -P 5 option specifies that up to 5 processes should be run in parallel
# The -I {} option specifies a placeholder for the argument
